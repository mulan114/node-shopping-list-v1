...
Recipes.create('hot chocolate', ['cocoa','sugar','milk']);
Recipes.create('spaghetti', ['pasta','ground turkey','spaghetti sauce']);
Recipes.create('cheeseburger', ['ground beef','cheese','bun']);
